<%-- 
    ...
    Created on : 12-Apr-2018, 5:05:10 AM
    Document   : admincust
...
<html lang="en">
  ...
  <body>
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="AdminController?action=admin_customer">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
              <div class="btn-group mr-2">
				...
				<input type="text" id="debut"name="custoDeb"></input>
      
			  
			     <span data-feather="calendar"></span>
			<input type="text" id="fin" name="custoFin"></input>
                        
                        <input type="submit" name="action" value="CUSTO"></input>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <p class="category">CA par client</p>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class ="col-md-4">
                                            <form method="post" action="<c:url value="AdminController"/>">
                                                ...
                                                <input type="text" id="debut"name="custoDeb" class="form-control" placeholder="date debut"></input>



                                                <input type="text" id="fin" name="custoFin" class="form-control" placeholder="date fin"></input>

                                                <input type="submit" name="action" value="CUSTO" class="btn btn-primary btn-sm"></input>
    ...
    <script>
      var key =[];
      var value=[];
      <c:forEach items="${ CAClient }" var="custo" varStatus="status">
      key.push("${custo.key}");
      value.push(${custo.value});
