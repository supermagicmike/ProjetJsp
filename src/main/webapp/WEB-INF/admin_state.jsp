                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        <h4 class="title">Etats</h4>
                                        <p class="category">CA par Etat</p>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class ="col-md-4">
                                            ...
                                            <form method="post" action="<c:url value="AdminController"/>">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="debut"name="etatDeb" class="form-control" placeholder="date debut"></input>



                                                    <input type="text" id="fin" name="etatFin" class="form-control" placeholder="date fin"></input>

                                                    <input type="submit" name="action" value="ETAT" class="btn btn-primary btn-sm"></input>
                                                </div>
                                            </form>
                                        </div>
                                        <div class ="col-md-4"></div>
